...
using InstitutoServices.Models.Notifications;
...
namespace InstitutoBack.DataContext
{
    public class InstitutoContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                string? cadenaConexion = "Server=127.0.0.1;port=3307;Database=app_institutodb;User=root;Password=;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //defino FirebaseUid como único en Usuarios para evitar que se repita
            modelBuilder.Entity<Usuario>()
                .HasIndex(u => u.FirebaseUid)
                .IsUnique()
                .HasFilter("[FirebaseUid] IS NOT NULL"); // Permite múltiples NULLs
            //defino Email como único en Usuarios para evitar que se repita
            modelBuilder.Entity<Usuario>()
                .HasIndex(u => u.Email)
                .IsUnique();
            //defino Email como único en alumnos para evitar que se repita
            modelBuilder.Entity<Alumno>()
                .HasIndex(a => a.Email)
                .IsUnique();
            //defino DNI como único en alumnos para evitar que se repita, permitiendo la repetición de espacios vacíos  
            modelBuilder.Entity<Alumno>()
                .HasIndex(a => a.Dni)
                .IsUnique()
